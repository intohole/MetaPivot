  ...
  window.Pages.Skills = {
    ...
    setup() {
      ...
      const columns = computed(() => {
        ...
        if (isAdmin.value) cols.push({ key: 'actions', label: '操作', width: '200px', align: 'center' })
        return cols
      })
      ...
      return {
        list, total, page, pageSize, keyword, sourceType, loading, columns,
        ...
        openTest, runTest, onPageChange, onSearch, state
      }
    },
    template: `
      <div class="space-y-4">
